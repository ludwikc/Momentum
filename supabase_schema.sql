...
-- =============================================================================
-- 14. PROFILE TAGS (2026-07). Canonical copy of scripts/profile_tags.sql —
-- redefines get_user_activity_stats (v4) over the v3 in section 13 (last
-- definition wins when the whole file is run).
-- =============================================================================
