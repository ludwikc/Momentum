...
<<<<<<< HEAD
    @commands.slash_command(name="kolejka", description="Dodaj siebie do kolejki do mówienia")
    ...
    @commands.slash_command(name="kolejka_next", description="Przejdź do następnej osoby w kolejce")
    ...
    @commands.slash_command(name="kolejka_done", description="Zakończ swoją kolej mówienia")
